...
public class StoresMapActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    private void initIntent()
    {
        ...
        mCityName = intent.getStringExtra(ConstantDaCheZuChe.IntentKey.CITY);
    }
    ...
    private void initMarkerData()
    {
        ...
        Log.e("initMarkerData ", "mCityName " + mCityName);
        params.put("page", (mPageNum -1) + "");
        HTTPUtils.post(StoresMapActivity.this, ConstantDaCheZuChe.URL.GET_STORES_MARKERS_LATLNG, params, new VolleyListener()
        {
            @Override
    ...
    public void initMarker()
    {
        ...
        if (mMStoresMarkerInfoContains != null && mMStoresMarkerInfoContains.size() > 0)
        {
            for (int i = 0; i < mMStoresMarkerInfoContains.size(); i++)
            {
                ...
                mMarker.setZIndex(i);
                Log.e("initMarker ", "initMarker（下标i）" + i);
            }
        }
            ...
            public boolean onMarkerClick(Marker marker)
            {
                ...
                inflate.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        data.putExtra(ConstantDaCheZuChe.IntentKey.STORES_ID_KEY,mMStoresMarkerInfoContains.get(mMarker.getZIndex()).getId() );
                        Log.e("initMarker ", "initMarker "+mMStoresMarkerInfoContains.get(mMarker.getZIndex()).getId());
                        setResult(ConstantDaCheZuChe.ResultCode.CHOOSE_STORE, data);
                        finish();
                    }
                });
                return true;
